...
test.skip('should create point shape with points', () => {
...
test.skip('should shift point shape', () => {
...
test.skip('should not mutate input points', () => {
...
test.skip('should get center of point shape', () => {
...
test.skip('should rotate point shape', () => {
...
test.skip('should determine if point is on edge', () => {
    const square = new PointShape({ points: [[-1, -1], [1, -1], [1, 1], [-1, 1]] });
